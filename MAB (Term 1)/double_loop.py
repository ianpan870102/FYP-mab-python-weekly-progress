    ...
    for algo in algorithms:
        ...
        for i in range(total_iteration):
            ...
            for t in range(timesteps):  # NOTE: 0 based? 1 based?
                ...
                algorithm_timestep_reward_stacked[t] += reward  # This persists over total_iterations
                if t != 0:
        ...
        for t in range(timesteps):
            average_reward_in_each_round[t] = float(algorithm_timestep_reward_stacked[t])/float(total_iteration)
